 ...
 * Created by Kshitij Gorde on 9/16/2016.
   This file contains the class definition of State and it's related methods
   Every configuration of the 8 puzzle will be represented by an object of State class
 */
...
public class State {
    ...
    public void printFinalPath(){                       //Tracing from the goal state upwards to the initial state by tracking parent.
        ...
        for(int i=finalPathList.size()-1;i>=0;i--){
            finalPathList.get(i).printTilePositions();
            System.out.println("-----");
        }
        System.out.println("Total states in the shortest path --->"+finalPathList.size());
    }
}
